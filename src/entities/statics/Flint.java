...
public class Flint extends StaticEntity{
	...
	public void render(Graphics g) {
		g.drawImage(Assets.flint, (int)(x - handler.getGameCamera().getxOffset()), (int)(y - handler.getGameCamera().getyOffset()), width, height, null);
	...
	public void die() {
		handler.getWorld().getItemManager().addItem(Item.flint.createNew((int) x + 16, (int) y + 16) );
	}
